...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        self.stdout.write("Clients      : http://127.0.0.1:8000/clients/")
        self.stdout.write("Fournisseurs : http://127.0.0.1:8000/fournisseurs/")
        self.stdout.write("Articles     : http://127.0.0.1:8000/articles/")
        self.stdout.write("="*30)
